...
import InfIcon1 from '/public/images/icon/location.png'
import InfIcon2 from '/public/images/icon/12.svg'
import InfIcon3 from '/public/images/icon/13.svg'
                    ...
                    <div className="row g-4">
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                            <div className="contact-info-items text-center">
                                <div className="icon">
                                    <Image src={InfIcon1} alt="icon-img" />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                            <div className="contact-info-items active text-center">
                                <div className="icon">
                                    <Image src={InfIcon2} alt="icon-img" />
                                </div>
                                <div className="content">
                                    <h3>Phone Number</h3>
                                    <p>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                            <div className="contact-info-items text-center">
                                <div className="icon">
                                    <Image src={InfIcon3} alt="icon-img" />
                                </div>
                                <div className="content">
                                    <h3>Mail Adress</h3>
                                    <p>
