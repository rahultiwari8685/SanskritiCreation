...
import Logo from "/public/images/logo/sanskriti_logo1.svg";
            ...
            <div className="header-main">
                    ...
                    <ul>
                      ...
                      {/* <li className="has-dropdown active d-xl-none">
                        ...
                        <ul className="submenu">
                          ...
                          <li>
                            <Link onClick={ClickHandler} href="/home-2">
                              Home 02
                            </Link>
                          </li>
                          <li>
                            <Link onClick={ClickHandler} href="/home-3">
                              Home 03
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li>
                        ...
                        <ul className="submenu">
                          ...
                          <li>
                            <Link
                              onClick={ClickHandler}
                              href="/service-details/Sticker-printing"
                            >
                              Service Details
                            </Link>
                          </li>
                      ...
                      {/* <li className="has-dropdown">
                        ...
                        <ul className="submenu">
                          ...
                          <li>
                            <Link
                              onClick={ClickHandler}
                              href="/project-details/3d-Genareted-Cate"
                            >
                              Project Details
                            </Link>
                          </li>
                      ...
                      {/* <li>
                        ...
                        <ul className="submenu">
                          ...
                          <li>
                            <Link
                              onClick={ClickHandler}
                              href="/shop-details/Calendar-printing-design"
                            >
                              Shop Details
                            </Link>
                          </li>
                      ...
                      {/* <li>
                        ...
                        <ul className="submenu">
                          ...
                          <li>
                            <Link
                              onClick={ClickHandler}
                              href="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food"
                            >
                              Blog Details
                            </Link>
                          </li>
              ...
              <div className="header-right d-flex justify-content-end align-items-center">
                ...
                <div className="content">
                  <p>HOTLINE</p>
                  <h5>
                    <a onClick={ClickHandler} href="del:00190081889">
                      00190081889
                    </a>
                  </h5>
                </div>
